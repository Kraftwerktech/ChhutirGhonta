            ...
            <div className=" justify-center mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-[30px] lg:gap-[50px] items-center">
                    <div className="flex flex-col justify-center items-center text-center">
                        <div className=' text-center justify-center items-center w-[700px]'>
                        <h1 className="text-[70px] font-bold text-white mt-[120px]">
                            Hello, Teacher!
                        </h1>
                        <p className="text-[55px] text-white mt-4">
